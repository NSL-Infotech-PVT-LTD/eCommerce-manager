...
class DataUser {
  ...
  ClubAdminDetail? clubAdminDetail;
  ...
  DataUser.fromJson(Map<String, dynamic> json) {
    ...
    clubAdminDetail = json['club_admin_detail'] != null
        ? new ClubAdminDetail.fromJson(json['club_admin_detail'])
        : null;
  }
...
class FiestaDetail {
  ...
  Null? filterLocal;
  Null? filterEnvironment;
  FilterMusic? filterMusic;
  FilterMusic? filterClothing;
  Null? filterSchedule;
  ...
  FiestaDetail.fromJson(Map<String, dynamic> json) {
    ...
    filterMusic = json['filter_music'] != null
        ? new FilterMusic.fromJson(json['filter_music'])
        : null;
    filterClothing = json['filter_clothing'] != null
        ? new FilterMusic.fromJson(json['filter_clothing'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['filter_music_id'] = this.filterMusicId;
    data['filter_clothing_id'] = this.filterClothingId;
    ...
    data['filter_local'] = this.filterLocal;
    data['filter_environment'] = this.filterEnvironment;
    ...
    data['filter_schedule'] = this.filterSchedule;
...
class FilterMusic {
  ...
  FilterMusic({this.name, this.nameEs});

  FilterMusic.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    nameEs = json['name_es'];
  }
...
class ClubDetail {
  ...
  ClubDetail.fromJson(Map<String, dynamic> json) {
    ...
    adminDetail = json['admin_detail'] != null
        ? new AdminDetail.fromJson(json['admin_detail'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.adminDetail != null) {
      data['admin_detail'] = this.adminDetail!.toJson();
    }
    return data;
  }
}
...
class ClubAdminDetail {
  int? id;
  String? name;
  Role? role;

  ClubAdminDetail({this.id, this.name, this.role});

  ClubAdminDetail.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    role = json['role'] != null ? new Role.fromJson(json['role']) : null;
  }
